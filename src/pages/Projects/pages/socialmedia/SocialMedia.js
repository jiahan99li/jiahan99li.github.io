            ...
            <div className="socialmedia-container">
                <div className="socialmedia-header">
                    ...
                    <div className="grid gap-8 content-center lg:grid-cols-3 md:grid-cols-2 flex justify-evenly card-section mt-[50px] mb-[50px]">
                        <section id="socialmedia-one" className="h-[350px] py-8 px-10 rounded-md overflow-hidden project-picture" />
                        <section id="socialmedia-two" className="h-[350px] py-8 px-10 rounded-md overflow-hidden" />
                        <section id="socialmedia-three" className="h-[350px] py-8 px-10 rounded-md overflow-hidden" />
                    </div>
                </div>
